...
export const VALIDATION_MESSAGES = {
    ...
    CONSUMERS_MAX: 'Максимальное количество потребителей - 12',
    ...
    LENGTH_OVER_150_WITH_OVERRIDE:
        'Вы выбрали нестандартный тип питания для длины более 150 м. Убедитесь в корректности.',
